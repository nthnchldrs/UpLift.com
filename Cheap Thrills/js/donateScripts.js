document.addEventListener('DOMContentLoaded', function () {
    ...
    const donationModal = document.getElementById('donateModal');
    const confirmationModal = document.getElementById('confirmationModal'); // Make sure to add this in your HTML
    ...
    donationForm.onsubmit = function (event) {
        ...
        // Here you can also send form data to server using AJAX/fetch
    };
});
